...
function MasonryImageList() {
  return (
    <Box
      sx={{ paddingLeft: "5%", width: "95%", height: 575, overflow: "scroll" }}
    >
...
const itemData = [
  ...
  },
  {
    img: niceGrey,
    title:
      "Clean Residential Exterior Driveway and Roof in Atlanta, North Georgia",
  },
  {
    img: window2,
    title:
      "premier commercial cleaning of industrial exterior and roof in Atlanta, Georgia",
  },
  {
    img: brickHouse,
    title:
      "Underground Atlanta Clean Commercial Exterior Services, best premier cleaning in North Georgia",
  },

  {
    img: trashCans,
    title:
      "Clean residential house, exterior roof and driveway in Atlanta, north deorgia",
  },
  {
    img: trucks,
    title:
